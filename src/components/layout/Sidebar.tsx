    ...
    entries: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Penggajian", href: "/employees/penggajian", icon: CreditCard, permission: "payroll" },
          { name: "Penggajian (Arsip)", href: "/employees/payroll", icon: Archive, permission: "payroll" },
