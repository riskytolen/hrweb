      ...
      <div className="relative z-10 flex flex-col h-full">
              ...
              return (
                <li key={item.name} className="relative group">
                  ...
                  >
                    ...
                    {isActive && (
                      <div className={cn(
                        "absolute inset-0 rounded-lg bg-gradient-to-r opacity-[0.15]",
                        item.color
                      )} />
                    )}
                    {/* Hover background */}
                    {!isActive && (
                      <div className="absolute inset-0 rounded-lg bg-white/0 group-hover:bg-white/[0.04]" />
                    )}
                    {/* Active left accent */}
                    {isActive && (
                      <div className={cn(
                        "absolute left-0 top-1/2 -translate-y-1/2 w-[2.5px] h-4 rounded-r-full bg-gradient-to-b",
                        item.color
                      )} />
                    )}
                    ...
                    <div className={cn(
                      ...
                      isActive
                        ? cn("bg-gradient-to-br shadow-md", item.color)
                  ...
                  {collapsed && (
                    <div className="absolute left-full top-1/2 -translate-y-1/2 ml-2.5 px-2.5 py-1 bg-slate-800 text-white text-[11px] font-medium rounded-md shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible whitespace-nowrap z-50 border border-white/10">
                      {item.name}
        ...
        <div className={cn("pb-2.5", collapsed ? "px-1.5" : "px-2")}>
          ...
          >
            ...
            />
            {!collapsed && (
              <span className="text-[10px] font-medium">Tutup</span>
            )}
          </button>
        </div>
      </div>
